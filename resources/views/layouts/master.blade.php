...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="LELA Admin Template v.1">
	<meta name="author" content="Tuan Bui">
	<meta name="keyword" content="">
	<meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Lela Admin Website</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('public/lelatemplate/asset/css/bootstrap.min.css')}}">
      ...
      <link rel="stylesheet" type="text/css" href="{{url('public/lelatemplate/asset/css/plugins/fullcalendar.min.css')}}"/>
      <link rel="stylesheet" type="text/css" href="{{url('public/lelatemplate/asset/css/plugins/datatables.bootstrap.min.css')}}"/>
	<link rel="stylesheet" href="{{url('public/lelatemplate/asset/css/style.css')}}" >
	<!-- end: Css -->
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
 ...
 <body id="mimin" class="dashboard">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>{{Auth::user()->name}}</span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="{{url('public/lelatemplate/asset/img/avatar.jpg')}}" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                   <ul class="dropdown-menu user-dropdown">
                     <li><a href="{{ url('/logout') }}"><span class="fa fa-btn fa-sign-out"></span>Logout</a></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a href="{{URL::to('home')}}" class="tree-toggle nav-header"><span class="fa-home fa"></span> Dashboard 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                          <li><a href="{{URL::to('usersdash')}}">User Dashboard</a></li>
                          <li><a href="{{URL::to('transdash')}}">Transaction Dashboard</a></li>
                      </ul>
                    </li>
                    <li class="ripple">
                      ...
                      <ul class="nav nav-list tree">
                         <li><a href="{{URL::to('transaction')}}">Transaction Table</a>
                         </li>                        
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-user fa"></span> User Management
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{URL::to('customer')}}">Client</a></li>
                        <li><a href="{{URL::to('interpreter')}}">Interpreter</a></li>
                      </ul>
                    </li>
                     <li class="ripple">
                        <a class="tree-toggle nav-header">
                          <span class="fa-comments-o fa"></span> Comment
                          <span class="fa-angle-right fa right-arrow text-right"></span>
                        </a>
                        <ul class="nav nav-list tree">
                          <li><a href="{{URL::to('comment')}}">Management</a></li>                        
                        </ul>
                      </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-credit-card fa"></span> Payment 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                         <li><a href="{{route('paymanager.index')}}">Management</a>
                         </li>                        
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-navicon fa"></span> Category 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                         <li><a href="{{route('cate.index')}}">Management</a>
                         </li>                        
                      </ul>
                    </li>
                    <li class="ripple"><a href="{{URL::to('calendar')}}"><span class="fa fa-calendar-o"></span>Calendar</a></li>
                  </ul>
                </div>
            </div>
          <!-- end: Left Menu -->
              ...
              <div class="tab-content">
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="{{url('public/lelatemplate/asset/img/avatar.jpg')}}" alt="user name">
                    </li>
                    <li class="away">
                      <img src="{{url('public/lelatemplate/asset/img/avatar.jpg')}}" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="{{url('public/lelatemplate/asset/img/avatar.jpg')}}" class=" img-responsive " alt="user name">
                            </div>
                          </div>
    ...
    <script src="{{url('public/lelatemplate/asset/js/plugins/fullcalendar.min.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/jquery.nicescroll.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/jquery.vmap.min.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/maps/jquery.vmap.world.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/jquery.vmap.sampledata.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/chart.min.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/jquery.datatables.min.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/datatables.bootstrap.min.js')}}"></script>
    <script src="{{url('public/lelatemplate/asset/js/plugins/jquery.nicescroll.js')}}"></script>
    <!-- custom -->
   <script src="{{url('public/lelatemplate/asset/js/main.js')}}"></script>
