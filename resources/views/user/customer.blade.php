...
<!-- start: Content -->
            <div id="content">
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3> Lela Client </h3></div>
                    <div class="panel-body">
                      ...
                      <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                              ...
                              @foreach($cus as $print) 
                                <tr>
                                  ...
                                  <td>
                                   <a class="btn btn-info btn-xs" href="{!! route('getcus',$print->id) !!}"><i class="fa fa-pencil fa-fw"></i> Edit</a>
                                  </td>
                                  <td>
                                      <form method="POST" action="{{route('delcus',$print->id)}}">      
                                      {!! csrf_field() !!}
